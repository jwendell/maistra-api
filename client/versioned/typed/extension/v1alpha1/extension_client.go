...
// ExtensionV1alpha1Client is used to interact with features provided by the extension group.
type ExtensionV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ExtensionV1alpha1Client) ServiceMeshExtensions(namespace string) ServiceMeshExtensionInterface {
