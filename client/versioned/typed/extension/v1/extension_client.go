...
import (
	...
	v1 "maistra.io/api/extension/v1"
)
...
// ExtensionV1Client is used to interact with features provided by the extension group.
type ExtensionV1Client struct {
	restClient rest.Interface
}

func (c *ExtensionV1Client) ServiceMeshExtensions(namespace string) ServiceMeshExtensionInterface {
