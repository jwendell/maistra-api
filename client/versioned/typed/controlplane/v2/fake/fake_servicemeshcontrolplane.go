...
type FakeServiceMeshControlPlanes struct {
	Fake *FakeControlplaneV2
	ns   string
}

var servicemeshcontrolplanesResource = schema.GroupVersionResource{Group: "controlplane", Version: "v2", Resource: "servicemeshcontrolplanes"}

var servicemeshcontrolplanesKind = schema.GroupVersionKind{Group: "controlplane", Version: "v2", Kind: "ServiceMeshControlPlane"}
