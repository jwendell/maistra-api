...
import (
	...
	v1alpha1 "maistra.io/api/client/listers/extension/v1alpha1"
	versioned "maistra.io/api/client/versioned"
	extensionv1alpha1 "maistra.io/api/extension/v1alpha1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ExtensionV1alpha1().ServiceMeshExtensions(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ExtensionV1alpha1().ServiceMeshExtensions(namespace).Watch(context.TODO(), options)
			},
		},
		&extensionv1alpha1.ServiceMeshExtension{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *serviceMeshExtensionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&extensionv1alpha1.ServiceMeshExtension{}, f.defaultInformer)
}
