...
import (
	...
	v1 "maistra.io/api/client/listers/extension/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ExtensionV1().ServiceMeshExtensions(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ExtensionV1().ServiceMeshExtensions(namespace).Watch(context.TODO(), options)
			},
		},
		&extensionv1.ServiceMeshExtension{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *serviceMeshExtensionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&extensionv1.ServiceMeshExtension{}, f.defaultInformer)
}
