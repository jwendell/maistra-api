...
import (
	...
	v1 "maistra.io/api/client/listers/memberroll/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.MemberrollV1().ServiceMeshMemberRolls(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MemberrollV1().ServiceMeshMemberRolls(namespace).Watch(context.TODO(), options)
			},
		},
		&memberrollv1.ServiceMeshMemberRoll{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *serviceMeshMemberRollInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&memberrollv1.ServiceMeshMemberRoll{}, f.defaultInformer)
}
