...
import (
	...
	v1alpha1 "maistra.io/api/client/listers/federation/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.FederationV1alpha1().MeshFederations(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.FederationV1alpha1().MeshFederations(namespace).Watch(context.TODO(), options)
			},
		},
		&federationv1alpha1.MeshFederation{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *meshFederationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&federationv1alpha1.MeshFederation{}, f.defaultInformer)
}
